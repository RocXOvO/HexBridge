...
- 当前公开正式版为 [v0.1.62](https://github.com/RocXOvO/HexBridge/releases/tag/v0.1.62)；本版包含 Tencent `bestHeroes` 英雄适配扩展、OP/T1–T5 英雄榜分组和独立英雄详情出装。Windows workflow 已通过，真实 Tencent 接口与用户同机验收仍待完成，HB-093/HB-094 保持 `IN PROGRESS / UNVERIFIED`。
