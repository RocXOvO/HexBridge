...
- 当前公开正式版：[v0.1.44](https://github.com/RocXOvO/HexBridge/releases/tag/v0.1.44)，Release ID `RE_kwDOT1eQs84WHuNV`；annotated tag 已解引用 tagged commit `eda3d76adc216293393ff951df1f6ba73475396d`。v0.1.45 为本地候选，包含高置信度冗余清理，尚未 commit/push、Windows、tag 或 Release。
