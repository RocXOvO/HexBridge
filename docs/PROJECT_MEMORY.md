...
- 当前公开正式版：[v0.1.56](https://github.com/RocXOvO/HexBridge/releases/tag/v0.1.56)，Release ID `371182988`，publishedAt `2026-08-15T23:24:29Z`；tagged commit `da178bf`。本版修正 Release notes 对无公开 Release 中间 tag 的累计与 compare 基线；稳定更新通道、packaged public 与滚动保留均通过，真实游戏刷新耗时仍待用户复测。
