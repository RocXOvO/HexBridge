...
- v0.1.55 为当前本地候选，保留 v0.1.54 的脱敏 OCR 调度诊断，并修正打包 UI smoke 对新增第 7 张诊断卡的数量门禁；公开正式版仍为 v0.1.53。v0.1.54 tag 已推送但 Windows UI smoke 因旧的 6 卡断言 fail closed，未创建 Release；v0.1.55 尚未 commit / push / Windows workflow / Release。真实机器性能仍待用户复测。
