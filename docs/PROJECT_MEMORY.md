...
- 当前公开正式版：[v0.1.44](https://github.com/RocXOvO/HexBridge/releases/tag/v0.1.44)，Release ID `RE_kwDOT1eQs84WHuNV`；annotated tag 已解引用 tagged commit `eda3d76adc216293393ff951df1f6ba73475396d`。v0.1.45 为已推送候选，包含高置信度冗余清理。
- v0.1.45 Windows workflow_dispatch `31901192560` 成功（48 files / 568 passed，artifact `9251192566` / 473533614 bytes）；尚未 tag 或 Release，不能写成正式发布。
...
- GitHub 当前只保留 v0.1.40～v0.1.44 五个正式 Releases；v0.1.0～v0.1.44 tags 全部保留。本地 `release/` 为空；旧 Release / assets 按滚动策略删除但 tag / source 保留。
