...
- v0.1.44 当前为已推送候选：仅收口选人助手备战席的内部滚动与横向溢出边界；本地 48 files / 566 passed + 1 skipped、typecheck、lint、diff-check 通过。Windows workflow_dispatch `31900108097` 成功（5m31s，artifact `9250901239` / 473533498 bytes），但尚未 tag 或 Release，不能写成正式发布。
