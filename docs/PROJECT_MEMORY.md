...
- 当前公开正式版：[v0.1.44](https://github.com/RocXOvO/HexBridge/releases/tag/v0.1.44)，Release ID `RE_kwDOT1eQs84WHuNV`；annotated tag 已解引用 tagged commit `eda3d76adc216293393ff951df1f6ba73475396d`。当前没有未发布候选。
