...
- 当前 Git / 版本：公开最新且唯一保留的 Release 为 `v0.1.8`，tag / 产品源码为 `b23b898b218b3e7a69bbc06b83bd3c88c7609db1`，public channel 为 `0.1.8`。远端所有 `v0.1.0` 至 `v0.1.8` Git tags 均原位保留；`v0.1.4` 从未有 Release。main / origin/main 当前亦为该发布提交；后续记忆收尾提交可领先于 tag，但不得改写 tag。
