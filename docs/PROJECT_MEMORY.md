...
- GitHub Actions 仍有 Node 20 deprecated annotation。当前 workflow 中第三方 actions 固定到完整 commit SHA，runner 已临时强制它们使用 Node 24；`v0.1.22` 正式 run `31806400237` 已成功，因此该 annotation 仍为非阻断维护项。
