...
- 当前候选版为 `v0.1.66`，公开正式版仍为 `v0.1.64`；v0.1.63 仅保留 tag、未创建公开 Release。v0.1.65 已推送 tag，但打包 UI smoke 因旧来源入口选择器 fail closed、未创建公开 Release；本候选修正该门禁并保留来源卡片配置入口，尚未 commit / push / Windows / tag / Release。
